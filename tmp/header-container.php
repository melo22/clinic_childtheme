...
<div id="header-container" class="header-container">
  <div class="header-container-in<?php echo get_additional_header_container_classes(); ?>">
    <header id="header" class="header<?php echo get_additional_header_classes(); ?> cf" style="background-image:url(<?php  echo get_header_background_image_url(); ?>);" itemscope itemtype="https://schema.org/WPHeader">
